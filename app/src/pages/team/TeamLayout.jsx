...
const getItems = (base) => [
  { to: `${base}`,              end: true, label: 'Overview',     adminOnly: true,  icon: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z' },
  ...
  { to: `${base}/api-usage`,    label: 'API Usage',   adminOnly: true,  icon: 'M3 3v18h18M7 14l3-3 4 4 5-7' },
    ...
    <div className="flex min-h-full">
      ...
      <aside className="sticky top-0 hidden h-[calc(100vh-4rem)] w-56 shrink-0 flex-col border-r border-black/[0.06] bg-white md:flex">
        <div className="px-5 py-5">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-[#aaa]">My Team</p>
        </div>
